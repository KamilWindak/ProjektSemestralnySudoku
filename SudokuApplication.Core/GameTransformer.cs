...
namespace SudokuApplication.Core
{
    ...
    /// </summary>
    public class GameTransformer : IGameTransformer
    {
        ...
        public void ShuffleSudoku(byte[][] sudokuBoard)
        {
            ...
            {
                var transformationType = (GameBoardTransformationType)this.random.Next(0, 6);
        ...
        private void TransformSudokuBoard(byte[][] sudokuBoard, GameBoardTransformationType type)
        {
            switch (type)
            {
                case GameBoardTransformationType.HorizontalIn9x3Group:
                    ...
                    break;
                case GameBoardTransformationType.HorizontalAroundFourthRow:
                    ...
                    break;
                case GameBoardTransformationType.VerticalIn3x9Group:
                    ...
                    break;
                case GameBoardTransformationType.VerticalAroundFourthColumn:
                    ...
                    break;
                case GameBoardTransformationType.AroundMainDiagonal:
                    ...
                    break;
                case GameBoardTransformationType.AroundMinorDiagonal:
                    ...
                    break;
                case GameBoardTransformationType.Horizontal9x3Group:
                    break;
                case GameBoardTransformationType.Vertical9x3Group:
                    break;
                default:
                    break;
            }
